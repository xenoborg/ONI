...
IconSelect.DEFAULT = {};
IconSelect.DEFAULT.SELECTED_ICON_WIDTH = 50;
IconSelect.DEFAULT.SELECTED_ICON_HEIGHT = 50;
IconSelect.DEFAULT.SELECTED_BOX_PADDING = 0;
IconSelect.DEFAULT.SELECTED_BOX_PADDING_RIGHT = 0;
...
IconSelect.COMPONENT_ICON_FILE_PATH = "arrow.png";
...
function IconSelect($$elementID, $$parameters) {
    ...
    _View.createUI = function($parameters){
        ...
        */
        ...
        _View.boxScrollElement.style.left = parseInt(selectedBoxElement.style.width) + 'px';
        
        _View.boxScrollElement.style.width = (($parameters.iconsWidth) * $parameters.vectoralIconNumber) + 
                (($parameters.vectoralIconNumber + 1) * $parameters.boxIconSpace) + 'px';
        _View.boxScrollElement.style.height = (($parameters.iconsHeight) * $parameters.horizontalIconNumber) + 'px';
    ...
    _View.createIcon = function($iconFilePath, $iconValue, $index, $parameters){
        ...
        iconElement.style.marginTop = '0px';
